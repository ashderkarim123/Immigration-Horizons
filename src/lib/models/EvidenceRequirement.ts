...
const EvidenceRequirementSchema = new mongoose.Schema(
  {
    ...
    linkedCategories: [
      { type: mongoose.Schema.Types.ObjectId, ref: "DocumentCategory" },
    ],
    linkedDocuments: [
      { type: mongoose.Schema.Types.ObjectId, ref: "CaseDocument" },
    ],
    linkedRequests: [
      { type: mongoose.Schema.Types.ObjectId, ref: "DocumentRequest" },
    ],
...
export const EvidenceRequirement =
  mongoose.models.EvidenceRequirement ||
  mongoose.model("EvidenceRequirement", EvidenceRequirementSchema);
