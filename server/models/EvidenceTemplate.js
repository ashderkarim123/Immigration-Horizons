...
const EvidenceTemplateSchema = new mongoose.Schema(
  {
    ...
    status: { type: String, enum: EVIDENCE_TEMPLATE_STATUSES, default: 'draft', index: true },
...
EvidenceTemplateSchema.statics.STATUSES = EVIDENCE_TEMPLATE_STATUSES;
EvidenceTemplateSchema.statics.IMPORTANCE = REQUIREMENT_IMPORTANCE;

module.exports = mongoose.model('EvidenceTemplate', EvidenceTemplateSchema);
