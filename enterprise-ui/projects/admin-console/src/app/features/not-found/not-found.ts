...
@Component({
  ...
  styles: `
    .not-found {
      ...
      min-height: 60vh;
      text-align: center;
      h1 { font-size: 4rem; font-weight: 800; color: var(--ih-gray-200); line-height: 1; }
      p { margin-top: var(--ih-space-3); color: var(--ih-text-secondary); }
      .back-link {
        ...
        &:hover { background: var(--ih-brand-700); }
      }
    }
  `,
})
